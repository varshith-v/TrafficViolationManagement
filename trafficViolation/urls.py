...
urlpatterns = [
    ...
    path('complaint',views.lodge_complaint, name="complaint"),path('dlRegister_page',views.dlRegister_page,name="dlRegister_page"),
    path('pay',views.pay,name="pay"),path('vehicleReg_page',views.vehicleReg_page,name="vehicleReg_page"),
